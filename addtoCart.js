...
function addToCart(index) {
        ...
        const productPrice = parseFloat(productContainer.querySelector('h6').innerText.replace('$', ''));
    ...
    function updateCart() {
        ...
        cartQuantity.innerText = cart.reduce((acc, product) => acc + product.quantity, 0);
